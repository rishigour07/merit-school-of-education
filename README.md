...
Without Supabase variables, the public site and admin dashboard run safely in fallback/demo mode. Enquiries still validate and can open WhatsApp, but are not persisted.
